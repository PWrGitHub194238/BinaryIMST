...
EdgeSetIF* IMSTSolverIF::getMST(EdgeCount k, EdgeSetIF* baseMSTSolution,
...
EdgeSetIF* IMSTSolverIF::getMST(EdgeCount k, VertexIF* initialVertex,
		GraphEdgeCostsIF* newGraphCosts) {
	return getMST(k, nullptr, initialVertex, newGraphCosts);
}

EdgeSetIF* IMSTSolverIF::getMST(EdgeCount k, EdgeSetIF* baseMSTSolution,
		GraphEdgeCostsIF* newGraphCosts) {
	return getMST(k, baseMSTSolution, nullptr, newGraphCosts);
}

EdgeSetIF* IMSTSolverIF::getMST(EdgeCount k, GraphEdgeCostsIF* newGraphCosts) {
	return getMST(k, nullptr, nullptr, newGraphCosts);
}

EdgeSetIF* IMSTSolverIF::getMST(EdgeCount k, EdgeSetIF* baseMSTSolution,
		VertexIF* initialVertex) {
	return getMST(k, baseMSTSolution, initialVertex, nullptr);
}

EdgeSetIF* IMSTSolverIF::getMST(EdgeCount k, VertexIF* initialVertex) {
	return getMST(k, nullptr, initialVertex, nullptr);
}

EdgeSetIF* IMSTSolverIF::getMST(EdgeCount k, EdgeSetIF* baseMSTSolution) {
	return getMST(k, baseMSTSolution, nullptr, nullptr);
}

EdgeSetIF* IMSTSolverIF::getMST(EdgeCount k) {
	return getMST(k, nullptr, nullptr, nullptr);
}
